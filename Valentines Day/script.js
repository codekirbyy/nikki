...
function showPhotos() {
    document.querySelector('.heart-fill').style.backgroundColor = "#ff4d6d";
    setTimeout(() => {
...
document.querySelector('.no-btn').addEventListener("mouseenter", moveButton);
document.querySelector('.yes-btn').addEventListener("click", startHeartFilling);
document.querySelector('.heart-outline').addEventListener("click", tapHeart);
